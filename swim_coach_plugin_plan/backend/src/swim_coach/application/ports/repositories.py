...
class TrainingPlansRepository(Protocol):
...
class TrainingPlanRevisionsRepository(Protocol):
    async def get(
...
class PlanSessionBindingsRepository(Protocol):
...
class PlanReviewsRepository(Protocol):
...
class PlanNotesRepository(Protocol):
...
class PrivacyRequestsRepository(Protocol):
    ...
    async def get_deletion(
        self, user_id: UserId, request_id: EntityId
...
class UnitOfWork(Protocol):
    ...
    @property
    def training_plans(self) -> TrainingPlansRepository: ...
    @property
    def training_plan_revisions(self) -> TrainingPlanRevisionsRepository: ...
    @property
    def plan_session_bindings(self) -> PlanSessionBindingsRepository: ...
    @property
    def plan_reviews(self) -> PlanReviewsRepository: ...
    @property
    def plan_notes(self) -> PlanNotesRepository: ...
    @property
    ...
    @property
    def privacy_requests(self) -> PrivacyRequestsRepository: ...
    @property
